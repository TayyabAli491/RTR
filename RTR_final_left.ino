...
int lSpeed = 255;//225 //250; //205
int rSpeed = 255;//225 //245; //200

int slightTurnSpeed = 80;//60  // Increased slight turn speed for faster turns
int sharpleft = 200; // Increased sharp turn speed for faster and smoother turns
int sharpright = 160; // Increased sharp turn speed for faster and smoother turns
